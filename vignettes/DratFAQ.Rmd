...
+ several [vignettes accessible from the package page](http://cran.r-project.org/package=drat)
and other places.
...
the [RcppRedis package](http://cran.r-project.org/package=RcppRedis) points
...
The [miniCRAN](http://cran.r-project.org/package=miniCRAN) package creates
